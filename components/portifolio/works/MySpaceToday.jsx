...
export default function MySpaceToday() {
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-slate-500">
                      If you're a 90's kid, like me, problably, you will remember MySpace. This is a modern remake made with <strong>JavaScript</strong> frameworks and libraries
                    </p>
                  </div>
